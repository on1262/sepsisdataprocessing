...
class CatboostForestTrainer():
    ...
    def train(self):
        ...
        # 开始训练
        dropout_generator = DropoutLabelGenerator(dropout=self.params['dropout'], miss_table=self.dataset.miss_table())
    ...
    def predict(self, mode, missrate=None):
        if missrate is None:
            ...
            dropout_generator = DropoutLabelGenerator(dropout=missrate, miss_table=self.dataset.miss_table())
